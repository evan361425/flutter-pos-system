...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('build app');
    routingConfig ??= ValueNotifier(Routes.getDesiredRoute(MediaQuery.sizeOf(context).width));
    ...
    return NotificationListener<SizeChangedLayoutNotification>(
      onNotification: (notification) {
        routingConfig!.value = Routes.getDesiredRoute(MediaQuery.sizeOf(context).width);
        return false;
      },
