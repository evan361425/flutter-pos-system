      ...
      text: TextSpan(
        children: [
          ...
          attr.defaultOption?.name != null
              ? TextSpan(
                  text: S.orderAttributeMetaDefault(attr.defaultOption!.name),
                )
              : TextSpan(
